...
import datetime
import src.core.subscribe_module as module
...
def getPredictData():
    ...
    try:
        ...
        for topic in all_topic:
            if topic == "temperature":
                predict_file="D:/github/IOT-project-based-on-MQTT/data/forecast-data/forecast_data_tem.csv"
            elif topic == "humidity":
                predict_file="D:/github/IOT-project-based-on-MQTT/data/forecast-data/forecast_data_Hum.csv"
            elif topic == "pressure":
                predict_file="D:/github/IOT-project-based-on-MQTT/data/forecast-data/forecast_data_Pre.csv"
            else:
                # 抛出异常
                raise Exception("Invalid topic")
